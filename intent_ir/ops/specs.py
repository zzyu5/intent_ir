...
_OP_SPECS: tuple[OpSpec, ...] = (
    ...
    OpSpec("tanh", "experimental", "elementwise", (1,)),
    ...
    OpSpec("angle", "experimental", "elementwise", (1,)),
    OpSpec("bitwise_and", "experimental", "elementwise", (2,)),
    OpSpec("bitwise_or", "experimental", "elementwise", (2,)),
    OpSpec("bitwise_not", "experimental", "elementwise", (1,)),
    OpSpec("bitwise_left_shift", "experimental", "elementwise", (2,)),
    OpSpec("bitwise_right_shift", "experimental", "elementwise", (2,)),
    ...
    OpSpec(
        ...
        (1,),
        attr_schema={
            "kernel_size": "int_or_int_list!",
            "stride": "int_or_int_list",
            "padding": "int_or_int_list",
            "ceil_mode": "bool",
    ...
    OpSpec(
        ...
        (2,),
        arity_mode="min",
        attr_schema={"stride": "int_or_int_list", "padding": "int_or_int_list", "dilation": "int_or_int_list", "groups": "int"},
    ),
    OpSpec(
        "conv3d",
        "experimental",
    ...
    OpSpec("trace", "experimental", "reduction", (1,)),
    OpSpec("triu", "experimental", "transform", (1,), attr_schema={"diagonal": "int"}),
    OpSpec(
        "upsample_nearest1d",
        "experimental",
        "semantic",
        (1,),
        attr_schema={"output_size": "int_or_int_list", "scales": "number", "scale_factor": "number"},
    ),
    OpSpec(
        "upsample_nearest2d",
        "experimental",
        "semantic",
        (1,),
        attr_schema={"output_size": "int_or_int_list", "scales_h": "number", "scales_w": "number"},
    ),
    ...
    OpSpec("scatter", "experimental", "index", (3,), attr_schema={"dim": "int", "reduce": "str"}),
    OpSpec("select_scatter", "experimental", "index", (2,), attr_schema={"dim": "int", "index": "int"}),
    OpSpec("slice_scatter", "experimental", "index", (2,), attr_schema={"dim": "int", "start": "int", "end": "int", "step": "int"}),
    OpSpec("quantile", "experimental", "reduction", (2,), attr_schema={"dim": "int", "keepdim": "bool", "interpolation": "str"}),
    OpSpec("polar", "experimental", "semantic", (2,)),
    OpSpec(
        ...
        (3,),
        arity_mode="min",
        attr_schema={"is_causal": "bool", "scale": "number"},
    ),
    OpSpec("weight_norm_interface", "experimental", "semantic", (2,), attr_schema={"dim": "int"}),
    OpSpec(
        "per_token_group_quant_fp8",
        "experimental",
        "semantic",
        (1,),
        attr_schema={"group_size": "int!", "eps": "number", "scale_ue8m0": "bool"},
    ),
    ...
    OpSpec("index_add", "experimental", "index", (3,), attr_schema={"axis": "int", "alpha": "number"}),
    OpSpec("index_put", "experimental", "index", (3,), arity_mode="min", attr_schema={"accumulate": "bool"}),
    # Macro ops.
