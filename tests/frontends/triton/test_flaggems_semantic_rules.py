...
def test_semantic_rule_templates_for_high_yield_ops() -> None:
    ...
    assert resolve_semantic_mapping("scaled_dot_product_attention").intent_ops == ("scaled_dot_product_attention",)
...
def test_semantic_rule_composite_aliases() -> None:
    ...
    assert resolve_semantic_mapping("scaled_dot_product_attention_forward").intent_ops == ("scaled_dot_product_attention",)
    assert resolve_semantic_mapping("flash_attention_forward").intent_ops == ("scaled_dot_product_attention",)
    assert resolve_semantic_mapping("ScaleDotProductAttention").intent_ops == ("scaled_dot_product_attention",)
