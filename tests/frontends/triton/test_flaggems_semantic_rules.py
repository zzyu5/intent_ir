...
def test_semantic_rule_templates_for_high_yield_ops() -> None:
    ...
    assert resolve_semantic_mapping("masked_select").intent_ops == ("masked_select",)
    ...
    assert resolve_semantic_mapping("select_scatter").intent_ops == ("select_scatter",)
    assert resolve_semantic_mapping("slice_scatter").intent_ops == ("slice_scatter",)
    ...
    assert resolve_semantic_mapping("std").intent_ops == ("std",)
