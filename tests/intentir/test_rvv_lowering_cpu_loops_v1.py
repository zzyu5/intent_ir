    ...
    return IntentFunction.from_json_dict(
        {
            ...
            "tensors": {
                ...
                "shift": {"dtype": "f32", "shape": ["M", "N"], "layout": "row_major"},
                "exp_vals": {"dtype": "f32", "shape": ["M", "N"], "layout": "row_major"},
                "sum_exp": {"dtype": "f32", "shape": ["M"], "layout": "row_major"},
            ...
            "ops": [
                {"op": "reduce_max", "inputs": ["inp"], "output": "mx", "attrs": {"dims": [1]}},
                {"op": "sub", "inputs": ["inp", "mx"], "output": "shift", "attrs": {}},
                {"op": "exp", "inputs": ["shift"], "output": "exp_vals", "attrs": {}},
                {"op": "reduce_sum", "inputs": ["exp_vals"], "output": "sum_exp", "attrs": {"dims": [1]}},
                {"op": "div", "inputs": ["exp_vals", "sum_exp"], "output": "softmax_out", "attrs": {}},
