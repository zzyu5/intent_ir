...
_INDEX_TEMPLATE: dict[str, SemanticMapping] = {
    ...
    "scatter": _mk(
        ...
        ("cast", "scatter"),
        mapping_kind="index_template",
        pattern_id="index.scatter_via_cast_scatter",
        detail="mapped as cast(index/update) then scatter update",
    ),
    "index_add": _mk(
        "index_add",
        ("cast", "index_add"),
        mapping_kind="index_template",
        pattern_id="index.index_add_via_cast_index_add",
        detail="mapped as cast(index) then index_add accumulation",
    ),
    "select_scatter": _mk(
        "select_scatter",
        ("where", "scatter"),
...
_MACRO_TEMPLATE: dict[str, SemanticMapping] = {
    ...
    "upsample_bicubic2d_aa": _mk(
        ...
        ("cast", "upsample_bicubic2d_aa", "cast"),
        mapping_kind="macro_template",
        pattern_id="macro.upsample_bicubic2d_aa_pre_post_cast",
        detail="mapped as pre-norm cast -> upsample_bicubic2d_aa -> post-norm cast",
    ),
    "zeros": _mk(
        "zeros",
    ...
    "avg_pool2d": _mk(
        "avg_pool2d",
        ("cast", "avg_pool2d", "cast"),
        mapping_kind="macro_template",
        pattern_id="macro.avg_pool2d_pre_post_cast",
        detail="mapped as pre-norm cast -> avg_pool2d -> post-norm cast",
    ),
    "arange": _mk(
        "arange",
        ("iota",),
    ...
    "conv1d": _mk(
        ...
        ("cast", "conv1d", "cast"),
        mapping_kind="macro_template",
        pattern_id="macro.conv1d_pre_post_cast",
        detail="mapped as pre-norm cast -> conv1d -> post-norm cast",
    ),
    "conv2d": _mk(
        "conv2d",
        ("cast", "conv2d", "cast"),
        mapping_kind="macro_template",
        pattern_id="macro.conv2d_pre_post_cast",
        detail="mapped as pre-norm cast -> conv2d -> post-norm cast",
    ),
    "conv3d": _mk(
        "conv3d",
        ("cast", "conv3d", "cast"),
        mapping_kind="macro_template",
        pattern_id="macro.conv3d_pre_post_cast",
        detail="mapped as pre-norm cast -> conv3d -> post-norm cast",
    ),
    "conv_depthwise2d": _mk(
        "conv_depthwise2d",
        ("cast", "conv_depthwise2d", "cast"),
        mapping_kind="macro_template",
        pattern_id="macro.conv_depthwise2d_pre_post_cast",
        detail="mapped as pre-norm cast -> conv_depthwise2d -> post-norm cast",
    ),
    "quantile": _mk(
        "quantile",
        ("quantile",),
    ...
    "upsample_nearest1d": _mk(
        "upsample_nearest1d",
        ("cast", "upsample_nearest1d", "cast"),
        mapping_kind="macro_template",
        pattern_id="macro.upsample_nearest1d_pre_post_cast",
        detail="mapped as pre-norm cast -> upsample_nearest1d -> post-norm cast",
    ),
    "upsample_nearest2d": _mk(
        "upsample_nearest2d",
        ("cast", "upsample_nearest2d", "cast"),
        mapping_kind="macro_template",
        pattern_id="macro.upsample_nearest2d_pre_post_cast",
        detail="mapped as pre-norm cast -> upsample_nearest2d -> post-norm cast",
    ),
    ...
    "cummax": _mk(
        ...
        ("cast", "cummax"),
        mapping_kind="macro_template",
        pattern_id="macro.cummax_via_cast",
        detail="mapped as cast(x) then cummax",
    ),
    "cummin": _mk(
        "cummin",
        ("cast", "cummin"),
        mapping_kind="macro_template",
        pattern_id="macro.cummin_via_cast",
        detail="mapped as cast(x) then cummin",
    ),
