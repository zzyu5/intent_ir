"""
Thin runner that invokes the reusable pipeline helpers for each kernel spec.

Kept minimal so new kernels can be plugged in via `scripts/pipeline_core.py`
...
from scripts.pipeline_core import default_kernel_specs, run_pipeline_for_spec
