...
from intent_ir.ir import IntentFunction, IntentIRValidationError, Op
...
def choose_tiles(intent: IntentFunction, profile: SPMDProfile, constraints: FrontendConstraints | None = None) -> TileChoice:
