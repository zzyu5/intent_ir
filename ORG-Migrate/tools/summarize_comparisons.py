...
def _flatten_comparison(path: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "guided_requested_sm": comp.get("guided_requested_sm"),
        "guided_effective_sm": comp.get("guided_effective_sm"),
        "guided_downleveled": comp.get("guided_downleveled"),
        ...
        "source_replay_requested_sm": comp.get("source_replay_requested_sm"),
        "source_replay_effective_sm": comp.get("source_replay_effective_sm"),
        "source_replay_downleveled": comp.get("source_replay_downleveled"),
        ...
        "source_replay_portable_requested_sm": comp.get("source_replay_portable_requested_sm"),
        "source_replay_portable_effective_sm": comp.get("source_replay_portable_effective_sm"),
        "source_replay_portable_downleveled": comp.get("source_replay_portable_downleveled"),
        ...
        "target_oracle_requested_sm": comp.get("target_oracle_requested_sm"),
        "target_oracle_effective_sm": comp.get("target_oracle_effective_sm"),
        "target_oracle_downleveled": comp.get("target_oracle_downleveled"),
        ...
        "target_oracle_portable_requested_sm": comp.get("target_oracle_portable_requested_sm"),
        "target_oracle_portable_effective_sm": comp.get("target_oracle_portable_effective_sm"),
        "target_oracle_portable_downleveled": comp.get("target_oracle_portable_downleveled"),
...
def main() -> int:
    ...
    fieldnames = [
        ...
        "source_replay_requested_sm",
        "source_replay_effective_sm",
        "source_replay_downleveled",
        "source_replay_portable_ratio",
        "source_replay_portable_qps_intentir",
        "source_replay_portable_qps_native",
        "source_replay_portable_requested_sm",
        "source_replay_portable_effective_sm",
        "source_replay_portable_downleveled",
        "target_oracle_raw_ratio",
        "target_oracle_raw_qps_intentir",
        "target_oracle_raw_qps_native",
        "target_oracle_requested_sm",
        "target_oracle_effective_sm",
        "target_oracle_downleveled",
        "target_oracle_portable_ratio",
        "target_oracle_portable_qps_intentir",
        "target_oracle_portable_qps_native",
        "target_oracle_portable_requested_sm",
        "target_oracle_portable_effective_sm",
        "target_oracle_portable_downleveled",
        "shared_native_qps",
